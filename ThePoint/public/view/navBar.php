...
<nav id="navMain" class="navbar navbar-inverse navbar-fixed-top">
    <div class="container-fluid">
        ...
        <ul class="nav navbar-nav">
            ...
            <li><a href="../../participantBundle/view/contact.php">Contact Us</a></li>
        </ul>
        <ul class="nav navbar-nav navbar-right">
            <li data-toggle="modal" data-target="#signupModal"><a href="#"><span
        ...
        <div class="modal-content" id="myform">
            ...
            <div class="modal-body">
                <form method="post"
                    ...
                    <div class="form-group" style="margin-bottom: 15px;">
                        <input type="text" class="form-control" name="email1" placeholder="Department" required>
                    </div>
                    <div class="form-group" style="margin-bottom: 15px;">
                        <input type="text" class="form-control" name="email2" placeholder="Level" required>
                    </div>
                    <div class="form-group" style="margin-bottom: 15px;">
